            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ ᴊᴏɪɴ ᴋᴀʀʟᴇ 🙂\n ᴘᴀɪꜱᴇ ɴᴀʜɪ ʟᴀɢᴇɢᴇ🙂➕", url=f"https://t.me/mojilagujrati")
                ]
...
async def start(client: Client, message: Message):
    await message.reply_video(
        video=f"https://telegra.ph/file/e7d2b22f8bb5a5af22bc1.mp4",
        caption=f"ᴢɪɴᴅᴀ ʜᴜɴ ᴍᴀɪɴ🙂\nᴀᴘɴᴇ ɢʀᴏᴜᴘ ᴍᴇ ᴀᴅᴅ ᴋᴀʀɴᴀ ʜᴀɪ ᴛᴏ 👇🙂",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "ʏᴀʜᴀ ᴅᴀʙᴀʏɪʏᴇ🙂", url=f"http://t.me/Voicechatmusicsbot?startgroup=true")
                ]
            ]
        ),
    )
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"ᴋʏᴀ ᴋᴀʀᴇɢᴀ ʀᴇᴘᴏ ᴋᴀ🙂",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "ᴊᴀᴀ ᴍᴀᴜᴊ ᴋᴀʀ🙂", url=f"https://github.com/iamdivyeshh/DivyeshMusicPlayer")
                ]
            ]
        ),
    )
