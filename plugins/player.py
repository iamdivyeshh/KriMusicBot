...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**𝐏𝐥𝐚𝐞𝐚𝐬𝐞  𝐌𝐚𝐧𝐮𝐚𝐥𝐥𝐲  𝐀𝐝𝐝  𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 :- @KriMusic_Bot \n𝐎𝐫  𝐂𝐨𝐧𝐭𝐚𝐜𝐭  𝐓𝐨 : @ZaYNxOP 🥀** ")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/aae2c88d000b029642e32.png"
            ...
            [
                [
                        InlineKeyboardButton(
                            ...
                            url=f"https://t.me/mojilagujrati")
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/b950587b5f10be16fc9e3.jpg", 
                             caption="**𓆩𐌺ᏒᎥ𓆪◞🖤 🔈 𝐌𝐮𝐬𝐢𝐜🤞𝐍𝐨𝐰 🥀\n▶️ 𝐏𝐚𝐮𝐬𝐞𝐝 🌷 ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**💥 𓆩𐌺ᏒᎥ𓆪◞🖤✨ 𝐍𝐨𝐭𝐡𝐢𝐧𝐠 🔇\n🚫 𝐏𝐥𝐚𝐲𝐢𝐧𝐠 🌷 ...**")
    else:
